...
var desks = {
	...
	"plot_8-79": {
		...
		"plot_12-1-A-bad-bad": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(Поле и дерево) Вам передали, что она боролась до последнего, но, видимо и правда светочи не живут долго…",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-1-A-good-2": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(х): Она бросилась к вам, она очень скучала.",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
					...
					"next": function(operators) {
						if (operators.M_Alia == 1) {
							return "plot_12-1-A-good-3-M" }
						return "plot_12-1-A-good-3-U" }
				},
				"2": {
					"text": {"ru": "Поцеловать", "en": "..."},
					"next": function(operators) {
		...
		"plot_12-1-A-good-3-M": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Алия: Я каждый день о тебе молилась…Медальон уберёг нас от чумы… ",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
					"text": { "ru": "...", "en": "..." },
					"next": function(operators) {
						return "plot_12-2-A-bad" }
				},
				"2": {
					"text": {"ru": "...", "en": "..."},
					"next": function(operators) {
						return "plot_12-2-A-good" }
				}
			}
		},
		"plot_12-1-A-good-3-U": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Алия: Я каждый день о тебе молилась…Бернар смог оградить нас чарами от чумы. Это так ужасно… ",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
					"text": { "ru": "Он молодец!", "en": "..." },
					"next": function(operators) {
						return "plot_12-2-U" }
				},
				"2": {
					"text": {"ru": "Главное, вы живы…", "en": "..."},
					"next": function(operators) {
						return "plot_12-2-U" }
				}
			}
		...
		"plot_12-1": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(красное солнце): Чума… Волею судеб или высшие силы так определили - теперь все иначе…уже третий месяц",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-2-U": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Ученик: Айвен! Я уже успел заскучать. Впрочем, я отлично справляюсь без тебя",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-2-C": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Зайдя в дом, на столе вы обнаружили записку.",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-3": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "((Городничий): Вы видели КТО завелся в нашем городе? Ужас! Это точно не к добру! (1- …; 2- Эм…)",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-4": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(Чумной Доктор): Доброго здравия, Мастер. Зашел поздороваться. Рад, что здесь пока все хорошо, хотя учитывая тенденции…",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-5": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Развязка4(Чумной Доктор): Ох! Вы не знаете? Над всем Королевством властвует чума! И все бы ничего, но колдун… Вряд ли это совпадение… (1- Что?; 2- Эм…)",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-6": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(Чумной Доктор): Доброго здравия, Мастер. Зашел поздороваться. Рад, что здесь пока все хорошо, хотя учитывая тенденции… (1- Что?; 2- Эм…)",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-7": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Цветочница: Вот. Эти травы, из которых готовят лекарство.",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-9": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Чародей: А вот и ты. Хотел дождаться тебя. Прежде чем уничтожу этот больной страдающий мир.",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-11": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Рыбак: Помогите… я не хочу умирать…",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-12": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(х): Неизвестный посетитель возник внезапно на пороге. Вы застыли, глядя на него.",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-15": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(х) : Странная мысль вдруг пришла вам в голову…",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-16": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(Х) : Через нескольких часов зелье обратной трансформации было готово. И вы дали испить его посетителю…",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-17": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Лунный торговец: Проклятье, Айвен! Где тебя носило все эти месяцы! Я уже три недели в теле птицы! ",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-18": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Лунный торговец: Твой демиург такой шутник! Или ты еще не понял, кто такой этот твой чародей?!",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-19": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(х): Ты уверен, что ему можно доверять? (Уверен)",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-20": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Лунный торговец: Уверен? Хм… А я уверен, что ты понятия не имеешь, кто он такой(о чем говоришь). Он должен уйти, иначе ты мне не друг!",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_12-21": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Лунный торговец:

				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_13-35-light-3": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Лунный торговец: О Великий Творец! Что это?",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_13-35-light-5": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(х): На ваших глазах оно обратилось в прах, и осколок с вашим именем упал к вашим ногам. И о, чудо! Ваша рука вдруг вернулась а изначальное состояние. ",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_13-35-light-5": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(х): На ваших глазах оно обратилось в прах, и осколок с вашим именем упал к вашим ногам…",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_13-35-light-6": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(х): …И о, чудо! Ваша рука вдруг вернулась а изначальное состояние. Теперь все будет хорошо…",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_13-35-light-7-ending-A": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Концовка: Хранители магии. Алие удалось восстановить компас, и магия вернулась в этот мир. Как и ваш давний друг. Он стал хорошим наставником вашим детям, тоже светочам.",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_13-35-light-7-ending": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Концовка: Сила человека. Все вернулось на круги своя, и вы стали обычным человеком, о чем всегда и мечтали. Только магия покинула этот мир, а значит вам придется искать другую профессию…",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_13-35-light-7-ending-C-1": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "Концовка:во власти океана. Вы покорились стихии, доверившись своей прекрасной колдунье. Вы были счастливы, даже не подозревая, что о вас и вашей любви уже слагают легенды.",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
		...
		"plot_13-35-dark-1": {
			"title": text.CHARACTER_0, "img": 0,
			"text": {
				"ru": "(Х) : Красное солнце разгоралось все ярче, пока все вокруг не растворилось в этом сиянии.",
				"en": "- Hello there! \n - General Kenobi..."
			},
			"answers": {
				"1": {
	...
	"rand12": { 
		...
		"rand_3_start": {
			"title": text.CHARACTER_0, "img": 26,
				"text": {
					"ru": "Посланник (если наследник не спасен) Его Величество призывает все волшебные силы страны.",
					"en": "If you want it, then you'll have to take it"
				},
			"answers": {
				"1": {
		...
		"rand_4_start": {
			"title": text.CHARACTER_0, "img": 26,
				"text": {
					"ru": "Смерть(с косой):Пир во время чумы! Это так по-человечески… (Уходи отсюда! Завидушь?)",
					"en": "If you want it, then you'll have to take it"
				},
			"answers": {
				"1": {
		...
		"rand_5_start": {
			"title": text.CHARACTER_0, "img": 26,
				"text": {
					"ru": "Б:Мой господин будет доволен",
					"en": "If you want it, then you'll have to take it"
				},
			"answers": {
				"1": {
		...
		"rand_7_start": {
			"title": text.CHARACTER_0, "img": 26,
				"text": {
					"ru": "Цветочница: Лекарственная полынь… Она не помогает. А что тогда помогает?(Успокойтесь, вот держите;Хм…)",
					"en": "If you want it, then you'll have to take it"
				},
			"answers": {
				"1": {
		...
		"rand_8_start": {
			"title": text.CHARACTER_0, "img": 26,
				"text": {
					"ru": "Лунный торговец: Вот, держи. Это маска, носи маску. (Не буду, Да, давай)",
					"en": "If you want it, then you'll have to take it"
				},
			"answers": {
				"1": {
		...
		"rand_10_start": {
			"title": text.CHARACTER_0, "img": 137,
				"text": {
					"ru": "Бабка: Это создатель нас покарал. Мы все скоро помрем.(Вздор это все!)",
					"en": "If you want it, then you'll have to take it"
				},
			"answers": {
				"1": {
		...
		"rand_11_start": {
			"title": text.CHARACTER_0, "img": 137,
				"text": {
					"ru": "Фальшивый герой: Я тут рецептик один… приобрел. Столичное лекарство Королевской гильдии.",
					"en": "If you want it, then you'll have to take it"
				},
			"answers": {
				"1": {
